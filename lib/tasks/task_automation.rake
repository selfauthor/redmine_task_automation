...
if Redmine::Plugin.registered_plugins.has_key?(:redmine_task_automation)
    ...
    namespace :task_automation do
      ...
      task test: :environment do
        ...
        begin
          ...
          # ====================================================================
          # Тест 2: Проверка кастомных полей
          ...
          if missing_fields.empty?
            ...
            # Вывод списка всех полей с их ID
            fields_with_ids = TaskAutomation.get_all_custom_fields_with_ids
